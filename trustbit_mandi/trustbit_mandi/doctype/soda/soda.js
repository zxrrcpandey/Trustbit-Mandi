...
frappe.ui.form.on('Soda', {
	refresh: function(frm) {
		...
		if (!frm.is_new() && frm.doc.status !== 'Cancelled'
			...
			frm.add_custom_button(__('Cancel Soda'), function() {
				frappe.confirm(
					__('Are you sure you want to cancel this Soda?'),
					function() {
...
function fetch_rate(frm) {
	...
	frappe.call({
		method: 'trustbit_mandi.trustbit_mandi.doctype.soda_price_list.soda_price_list.get_rate_for_pack_size',
		args: {
