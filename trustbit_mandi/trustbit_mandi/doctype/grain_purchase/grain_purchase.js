    ...
    frappe.call({
        ...
        callback: function(r) {
            if (r.message && r.message.is_active) {
                ...
                // Find best matching rate from history
                ...
                // Fallback to current master rate
                if (!applicable_rate) {
                    applicable_rate = {
                        effective_date: master.effective_date,
                        upto_60_kg: master.upto_60_kg,
                        more_than_60_kg: master.more_than_60_kg
                    };
                }
                ...
                frappe.show_alert({
                    message: __('Hamali Rate: {0} (for {1} KG bags)', [hamali_rate.toFixed(2), kg_per_bag <= 60 ? '60' : '80']),
                    indicator: 'green'
                }, 3);
