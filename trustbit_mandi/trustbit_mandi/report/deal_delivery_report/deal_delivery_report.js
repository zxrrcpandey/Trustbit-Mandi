...
frappe.query_reports["Deal Delivery Report"] = {
	onload: function(report) {
		report.page.add_inner_button(__("Print PDF"), function() {
			print_report_pdf(report, "Deal Delivery Report");
		});
	},
	"filters": [
		{
		...
		{
			"fieldname": "vehicle_dispatch",
			"label": __("Vehicle Dispatch"),
			"fieldtype": "Link",
			"options": "Vehicle Dispatch"
		},
		{
			"fieldname": "status",
			"label": __("Status"),
